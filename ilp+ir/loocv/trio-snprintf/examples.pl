...
goodFlag('jfdctint','-fivopts').
:- badFlag('jfdctint','-fivopts').
goodFlag('jfdctint','-fmove-loop-invariants').
:- badFlag('jfdctint','-fmove-loop-invariants').
:- goodFlag('jfdctint','-fschedule-insns').
badFlag('jfdctint','-fschedule-insns').
goodFlag('jfdctint','-ftree-loop-optimize').
:- badFlag('jfdctint','-ftree-loop-optimize').
