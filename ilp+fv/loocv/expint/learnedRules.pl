...
badFlag(A,'-fipa-cp') :- ft(ft7,A,0), ft(ft23,A,0).
...
badFlag(A,'-fsched-spec-insn-heuristic') :- ft(ft14,A,0).
...
badFlag(A,'-ftree-slp-vectorize') :- ft(ft6,A,0).
...
badFlag(A,'-fdevirtualize') :- ft(ft14,A,0).
