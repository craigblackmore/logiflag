...
badFlag(A,'-fivopts') :- ft(ft4,A,0), ft(ft14,A,0), ft(ft51,A,
	0).
...
badFlag(A,'-fcombine-stack-adjustments') :- ft(ft7,A,0), ft(ft10,
	A,0).
...
badFlag(A,'-fexpensive-optimizations').
...
badFlag(A,'-fhoist-adjacent-loads') :- ft(ft51,A,0).
...
badFlag(A,'-fprefetch-loop-arrays') :- ft(ft17,A,0).
