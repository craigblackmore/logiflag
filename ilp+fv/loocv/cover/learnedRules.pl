...
badFlag(A,'-foptimize-sibling-calls') :- ft(ft14,A,0), ft(ft43,
	A,0), large_ft(A,ft7).
badFlag(A,'-fsched-pressure') :- ft(ft14,A,0), ft(ft19,A,0), 
	ft(ft34,A,0).
badFlag(A,'-ftree-vrp') :- ft(ft43,A,0), large_ft(A,ft7), large_ft(A,
	ft48).
...
badFlag(A,'-ftree-loop-optimize') :- ft(ft7,A,0), ft(ft15,A,0),
	ft(ft19,A,0), ft(ft23,A,0), non_zero(A,ft53).
