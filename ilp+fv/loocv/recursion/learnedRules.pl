...
badFlag(A,'-frename-registers') :- small_ft(A,ft47).
...
badFlag(A,'-fcrossjumping') :- ft(ft7,A,0).
...
badFlag(A,'-ftree-loop-distribute-patterns') :- ft(ft19,A,0).
badFlag(A,'-ftree-reassoc') :- ft(ft14,A,0).
badFlag(A,'-fsection-anchors') :- ft(ft23,A,0), ft(ft42,A,0).
badFlag(A,'-ftree-pre') :- ft(ft7,A,0), ft(ft40,A,0).
badFlag(A,'-ftree-slp-vectorize') :- ft(ft7,A,0), ft(ft35,A,0).
badFlag(A,'-finline') :- ft(ft4,A,0), ft(ft7,A,0), ft(ft9,A,0),
	ft(ft14,A,0), ft(ft51,A,0).
badFlag(A,'-fschedule-insns2') :- ft(ft14,A,0).
badFlag(A,'-fselective-scheduling2') :- ft(ft7,A,0), small_ft(A,
	ft36).
badFlag(A,'-ftree-phiprop').
badFlag(A,'-faggressive-loop-optimizations') :- ft(ft14,A,0),
	ft(ft23,A,0), large_ft(A,ft29).
badFlag(A,'-falign-functions') :- large_ft(A,ft1).
badFlag(A,'-fcommon') :- ft(ft35,A,0).
badFlag(A,'-fcse-follow-jumps').
badFlag(A,'-foptimize-sibling-calls') :- ft(ft4,A,0), ft(ft14,
	A,0), ft(ft31,A,0), ft(ft43,A,0), large_ft(A,ft7).
badFlag(A,'-fsched-pressure') :- ft(ft14,A,0), ft(ft19,A,0), 
	ft(ft34,A,0).
badFlag(A,'-ftree-vrp') :- ft(ft4,A,0), ft(ft19,A,0), large_ft(A,
	ft51).
badFlag(A,'-funroll-loops').
badFlag(A,'-fcombine-stack-adjustments') :- ft(ft7,A,0), ft(ft34,
	A,0).
badFlag(A,'-fguess-branch-probability') :- ft(ft39,A,0), ft(ft42,
	A,0), large_ft(A,ft3), large_ft(A,ft11), qt(A,ft47,3).
badFlag(A,'-fpeephole2').
...
badFlag(A,'-ftree-sra') :- ft(ft7,A,0), ft(ft35,A,0).
badFlag(A,'-ftree-ter') :- ft(ft7,A,0), ft(ft10,A,0).
badFlag(A,'-fvariable-expansion-in-unroller') :- ft(ft7,A,0),
	ft(ft10,A,0).
badFlag(A,'-fsched-spec-load').
...
badFlag(A,'-fsel-sched-pipelining') :- ft(ft7,A,0), ft(ft19,A,
	0).
badFlag(A,'-ftree-dce') :- ft(ft7,A,0), ft(ft14,A,0), ft(ft17,
	A,0), ft(ft54,A,0).
badFlag(A,'-falign-labels').
badFlag(A,'-fexpensive-optimizations') :- ft(ft3,A,0).
badFlag(A,'-fipa-pure-const') :- small_ft(A,ft2).
badFlag(A,'-fipa-sra').
badFlag(A,'-fvect-cost-model') :- ft(ft3,A,0).
badFlag(A,'-ftree-loop-optimize') :- ft(ft4,A,0), ft(ft7,A,0),
...
badFlag(A,'-fbranch-count-reg').
badFlag(A,'-finline-atomics') :- ft(ft14,A,0).
badFlag(A,'-fipa-cp-clone') :- ft(ft14,A,0), ft(ft35,A,0), large_ft(A,
	ft19).
badFlag(A,'-fpredictive-commoning') :- ft(ft51,A,0).
...
badFlag(A,'-ftree-builtin-call-dce') :- ft(ft14,A,0).
badFlag(A,'-ftree-cselim').
badFlag(A,'-freorder-blocks') :- ft(ft9,A,0).
badFlag(A,'-fcaller-saves') :- ft(ft14,A,0).
...
badFlag(A,'-ftree-loop-if-convert') :- ft(ft7,A,0), ft(ft9,A,
	0).
badFlag(A,'-ftree-forwprop') :- ft(ft10,A,0).
...
badFlag(A,'-fgcse-sm') :- large_ft(A,ft14).
badFlag(A,'-fif-conversion') :- ft(ft7,A,0), ft(ft17,A,0).
badFlag(A,'-fprefetch-loop-arrays') :- large_ft(A,ft14).
badFlag(A,'-fsched-group-heuristic').
badFlag(A,'-ftree-ccp') :- ft(ft17,A,0).
badFlag(A,'-ftree-scev-cprop') :- ft(ft17,A,0).
