...
badFlag(A,'-fschedule-insns') :- ft(ft9,A,0), non_zero(A,ft3).
badFlag(A,'-ftree-fre') :- ft(ft7,A,0).
badFlag(A,'-fcprop-registers') :- ft(ft51,A,0).
badFlag(A,'-ftree-vect-loop-version').
...
badFlag(A,'-fivopts') :- ft(ft4,A,0), ft(ft14,A,0), large_ft(A,
	ft50).
badFlag(A,'-fsel-sched-reschedule-pipelined') :- ft(ft43,A,0).
...
badFlag(A,'-fselective-scheduling2') :- ft(ft23,A,0).
...
badFlag(A,'-fsched-critical-path-heuristic') :- ft(ft10,A,0).
...
badFlag(A,'-ftree-loop-optimize') :- ft(ft4,A,0), ft(ft7,A,0),
	ft(ft15,A,0), ft(ft23,A,0), qt(A,ft51,3).
...
badFlag(A,'-fdse').
badFlag(A,'-fexpensive-optimizations') :- ft(ft6,A,0).
...
badFlag(A,'-fvect-cost-model') :- ft(ft6,A,0).
...
badFlag(A,'-fipa-cp-clone') :- ft(ft14,A,0), ft(ft35,A,0), large_ft(A,
	ft19).
badFlag(A,'-fipa-pure-const') :- ft(ft31,A,0), ft(ft35,A,0).
badFlag(A,'-fipa-sra').
...
badFlag(A,'-ftree-builtin-call-dce') :- large_ft(A,ft6).
