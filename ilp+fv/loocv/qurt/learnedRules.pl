...
badFlag(A,'-fbranch-target-load-optimize').
badFlag(A,'-frename-registers') :- small_ft(A,ft14).
badFlag(A,'-fschedule-insns') :- ft(ft9,A,0), non_zero(A,ft6).
badFlag(A,'-ftree-fre') :- ft(ft7,A,0).
badFlag(A,'-fcprop-registers') :- qt(A,ft45,4).
...
badFlag(A,'-fsection-anchors') :- small_ft(A,ft35).
...
badFlag(A,'-fguess-branch-probability') :- ft(ft31,A,0), ft(ft39,
	A,0), ft(ft42,A,0), large_ft(A,ft3), qt(A,ft47,3).
badFlag(A,'-fpeephole2') :- ft(ft7,A,0).
badFlag(A,'-fsched-critical-path-heuristic') :- ft(ft23,A,0).
...
badFlag(A,'-ftree-ter') :- ft(ft10,A,0).
...
badFlag(A,'-fipa-cp') :- ft(ft7,A,0), ft(ft23,A,0), small_ft(A,
	ft1).
badFlag(A,'-fipa-reference') :- ft(ft7,A,0).
badFlag(A,'-fsched-dep-count-heuristic') :- ft(ft4,A,0).
...
badFlag(A,'-finline-atomics') :- ft(ft14,A,0), ft(ft31,A,0).
badFlag(A,'-fipa-cp-clone') :- ft(ft14,A,0), ft(ft23,A,0), ft(ft34,
	A,0).
...
badFlag(A,'-ftree-ch') :- ft(ft4,A,0), ft(ft7,A,0), ft(ft14,A,
	0), ft(ft47,A,0).
badFlag(A,'-ftree-loop-distribution') :- ft(ft14,A,0).
...
badFlag(A,'-fsched-last-insn-heuristic') :- ft(ft7,A,0), ft(ft17,
	A,0).
badFlag(A,'-ftree-ccp') :- ft(ft7,A,0), ft(ft17,A,0).
badFlag(A,'-ftree-cselim') :- ft(ft7,A,0).
