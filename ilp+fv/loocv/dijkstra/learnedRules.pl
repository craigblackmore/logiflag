...
badFlag(A,'-fcrossjumping') :- ft(ft4,A,0).
...
badFlag(A,'-fivopts') :- ft(ft4,A,0), ft(ft14,A,0), large_ft(A,
	ft50).
badFlag(A,'-fsel-sched-reschedule-pipelined') :- ft(ft14,A,0).
...
badFlag(A,'-ftree-slp-vectorize') :- ft(ft35,A,0).
...
badFlag(A,'-falign-functions') :- ft(ft14,A,0).
badFlag(A,'-fcommon') :- large_ft(A,ft2).
badFlag(A,'-fcse-follow-jumps').
badFlag(A,'-foptimize-sibling-calls') :- ft(ft4,A,0), ft(ft14,
	A,0), large_ft(A,ft7).
badFlag(A,'-fsched-pressure') :- ft(ft14,A,0), ft(ft34,A,0).
badFlag(A,'-ftree-vrp') :- ft(ft4,A,0), large_ft(A,ft7), large_ft(A,
	ft48).
...
badFlag(A,'-ftree-sra') :- ft(ft35,A,0).
...
badFlag(A,'-fsched-spec-insn-heuristic') :- ft(ft19,A,0).
...
badFlag(A,'-fipa-pure-const') :- ft(ft31,A,0), ft(ft53,A,0).
badFlag(A,'-fipa-sra').
...
badFlag(A,'-finline-atomics') :- ft(ft10,A,0), ft(ft31,A,0).
badFlag(A,'-fipa-cp-clone') :- ft(ft10,A,0), ft(ft14,A,0).
...
badFlag(A,'-fcaller-saves') :- ft(ft7,A,0), ft(ft14,A,0).
badFlag(A,'-fdevirtualize') :- ft(ft19,A,0).
badFlag(A,'-fipa-pta').
