...
badFlag(A,'-fselective-scheduling2') :- ft(ft10,A,0), ft(ft23,
	A,0).
...
badFlag(A,'-fsched-pressure') :- ft(ft19,A,0), ft(ft34,A,0).
...
badFlag(A,'-ftree-ter') :- ft(ft7,A,0).
...
badFlag(A,'-ftree-loop-optimize') :- ft(ft4,A,0), ft(ft7,A,0),
	ft(ft14,A,0), ft(ft19,A,0), ft(ft34,A,0).
...
badFlag(A,'-finline-atomics') :- ft(ft31,A,0).
...
badFlag(A,'-ftree-forwprop') :- ft(ft7,A,0).
...
badFlag(A,'-fipa-cp') :- ft(ft7,A,0), ft(ft29,A,0).
