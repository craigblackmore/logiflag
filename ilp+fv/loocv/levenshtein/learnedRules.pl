...
badFlag(A,'-fschedule-insns') :- non_zero(A,ft6).
...
badFlag(A,'-fivopts') :- ft(ft4,A,0), ft(ft14,A,0), large_ft(A,
	ft50).
badFlag(A,'-fsel-sched-reschedule-pipelined') :- ft(ft29,A,0).
...
badFlag(A,'-faggressive-loop-optimizations') :- ft(ft23,A,0),
	large_ft(A,ft29).
...
badFlag(A,'-fipa-cp') :- ft(ft7,A,0), ft(ft19,A,0).
...
badFlag(A,'-fgcse') :- ft(ft7,A,0).
badFlag(A,'-fsched-spec-insn-heuristic') :- ft(ft49,A,0).
badFlag(A,'-fsel-sched-pipelining') :- ft(ft29,A,0).
badFlag(A,'-ftree-dce') :- ft(ft7,A,0), ft(ft14,A,0), ft(ft17,
	A,0), ft(ft54,A,0).
badFlag(A,'-ftree-sra') :- ft(ft17,A,0).
...
badFlag(A,'-freschedule-modulo-scheduled-loops') :- ft(ft6,A,
	0).
badFlag(A,'-ftree-loop-if-convert') :- ft(ft23,A,0).
badFlag(A,'-ftree-scev-cprop') :- ft(ft6,A,0).
badFlag(A,'-funroll-all-loops') :- ft(ft6,A,0).
badFlag(A,'-ftree-loop-optimize') :- ft(ft4,A,0), ft(ft7,A,0),
	ft(ft15,A,0), large_ft(A,ft40).
badFlag(A,'-fhoist-adjacent-loads') :- large_ft(A,ft48).
badFlag(A,'-fsplit-ivs-in-unroller') :- ft(ft45,A,0).
...
badFlag(A,'-fsched-last-insn-heuristic') :- ft(ft10,A,0), ft(ft31,
	A,0).
...
badFlag(A,'-ftree-ch') :- ft(ft4,A,0), ft(ft7,A,0), ft(ft14,A,
	0), ft(ft47,A,0).
badFlag(A,'-ftree-loop-distribution') :- ft(ft7,A,0).
