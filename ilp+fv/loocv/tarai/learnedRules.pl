...
badFlag(A,'-fcprop-registers') :- small_ft(A,ft2).
...
badFlag(A,'-ftree-dce') :- ft(ft7,A,0), ft(ft14,A,0), ft(ft17,
	A,0), ft(ft54,A,0).
badFlag(A,'-ftree-sra') :- ft(ft14,A,0), ft(ft29,A,0), ft(ft35,
	A,0).
badFlag(A,'-fguess-branch-probability') :- ft(ft31,A,0), ft(ft39,
	A,0), ft(ft42,A,0), large_ft(A,ft3), large_ft(A,ft36).
...
badFlag(A,'-freorder-blocks') :- ft(ft10,A,0), large_ft(A,ft41).
...
badFlag(A,'-fsplit-ivs-in-unroller') :- ft(ft39,A,0).
